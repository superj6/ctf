...
(function() {
  ...
  InspectorIssueCode.kDeprecationIssue = 10;
  InspectorIssueCode.MIN_VALUE = 0;
  InspectorIssueCode.MAX_VALUE = 10;
  ...
  FederatedAuthRequestResult.kErrorConfigNotInWellKnown = 8;
  FederatedAuthRequestResult.kErrorWellKnownTooBig = 9;
  FederatedAuthRequestResult.kErrorFetchingConfigHttpNotFound = 10;
  FederatedAuthRequestResult.kErrorFetchingConfigNoResponse = 11;
  FederatedAuthRequestResult.kErrorFetchingConfigInvalidResponse = 12;
  FederatedAuthRequestResult.kErrorFetchingClientMetadataHttpNotFound = 13;
  FederatedAuthRequestResult.kErrorFetchingClientMetadataNoResponse = 14;
  FederatedAuthRequestResult.kErrorFetchingClientMetadataInvalidResponse = 15;
  FederatedAuthRequestResult.kErrorFetchingAccountsHttpNotFound = 16;
  FederatedAuthRequestResult.kErrorFetchingAccountsNoResponse = 17;
  FederatedAuthRequestResult.kErrorFetchingAccountsInvalidResponse = 18;
  FederatedAuthRequestResult.kErrorFetchingAccountsListEmpty = 19;
  FederatedAuthRequestResult.kErrorFetchingIdTokenHttpNotFound = 20;
  FederatedAuthRequestResult.kErrorFetchingIdTokenNoResponse = 21;
  FederatedAuthRequestResult.kErrorFetchingIdTokenInvalidResponse = 22;
  FederatedAuthRequestResult.kErrorCanceled = 23;
  FederatedAuthRequestResult.kErrorRpPageNotVisible = 24;
  FederatedAuthRequestResult.kError = 25;
  FederatedAuthRequestResult.MIN_VALUE = 0;
  FederatedAuthRequestResult.MAX_VALUE = 25;
  ...
  GenericIssueErrorType.MAX_VALUE = 9;
  ...
  InspectorIssueDetails.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, DeprecationIssueDetails, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InspectorIssueDetails.encodedSize = codec.kStructHeaderSize + 96;
