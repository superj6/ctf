...
(function() {
  ...
  MediaSessionAction.MAX_VALUE = 19;
  ...
  RemotePlaybackMetadata.prototype.initDefaults_ = function() {
    ...
    this.remotingDeviceFriendlyName = null;
  };
  ...
  RemotePlaybackMetadata.validate = function(messageValidator, offset) {
    ...
    // version check RemotePlaybackMetadata.remotingDeviceFriendlyName
    if (!messageValidator.isFieldInStructVersion(offset, 17))
      return validator.validationError.NONE;
    // validate RemotePlaybackMetadata.remotingDeviceFriendlyName
  ...
  RemotePlaybackMetadata.decode = function(decoder) {
    ...
    decoder.skip(1);
    if (version >= 17) {
      val.remotingDeviceFriendlyName =
          decoder.decodeStruct(codec.NullableString);
    } else {
      val.remotingDeviceFriendlyName = null;
    }
    return val;
  };
  ...
  RemotePlaybackMetadata.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStruct(codec.NullableString, val.remotingDeviceFriendlyName);
  };
