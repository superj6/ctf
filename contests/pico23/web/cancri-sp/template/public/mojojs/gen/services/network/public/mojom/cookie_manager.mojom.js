...
(function() {
  ...
  CookieManagerParams.prototype.initDefaults_ = function() {
    ...
    this.settingsForTopLevelStorageAccess = null;
  };
  ...
  CookieManagerParams.validate = function(messageValidator, offset) {
    ...
    // validate CookieManagerParams.settingsForTopLevelStorageAccess
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 56, 8, new codec.PointerTo(content_settings$.ContentSettingPatternSource), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManagerParams.encodedSize = codec.kStructHeaderSize + 64;
  ...
  CookieManagerParams.decode = function(decoder) {
    ...
    val.settingsForStorageAccess =
        decoder.decodeArrayPointer(new codec.PointerTo(content_settings$.ContentSettingPatternSource));
    val.settingsForTopLevelStorageAccess =
        decoder.decodeArrayPointer(new codec.PointerTo(content_settings$.ContentSettingPatternSource));
    return val;
  };
  ...
  CookieManagerParams.encode = function(encoder, val) {
    ...
    encoder.encodeArrayPointer(new codec.PointerTo(content_settings$.ContentSettingPatternSource), val.settingsForTopLevelStorageAccess);
  };
  ...
  function CookieManager_SetTopLevelStorageAccessSettings_Params(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CookieManager_SetTopLevelStorageAccessSettings_Params.prototype.initDefaults_ = function() {
    this.settings = null;
  };
  CookieManager_SetTopLevelStorageAccessSettings_Params.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CookieManager_SetTopLevelStorageAccessSettings_Params.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate CookieManager_SetTopLevelStorageAccessSettings_Params.settings
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(content_settings$.ContentSettingPatternSource), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManager_SetTopLevelStorageAccessSettings_Params.encodedSize = codec.kStructHeaderSize + 8;

  CookieManager_SetTopLevelStorageAccessSettings_Params.decode = function(decoder) {
    var packed;
    var val = new CookieManager_SetTopLevelStorageAccessSettings_Params();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.settings =
        decoder.decodeArrayPointer(new codec.PointerTo(content_settings$.ContentSettingPatternSource));
  ...
  CookieManager_SetTopLevelStorageAccessSettings_Params.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CookieManager_SetTopLevelStorageAccessSettings_Params.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(content_settings$.ContentSettingPatternSource), val.settings);
  };
  function CookieManager_SetTopLevelStorageAccessSettings_ResponseParams(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.prototype.initDefaults_ = function() {
  };
  CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.encodedSize = codec.kStructHeaderSize + 0;

  CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.decode = function(decoder) {
    var packed;
    var val = new CookieManager_SetTopLevelStorageAccessSettings_ResponseParams();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    return val;
  };

  CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.encodedSize);
    encoder.writeUint32(0);
  };
  ...
  var kCookieChangeListener_OnCookieChange_Name = 2061788738;
  ...
  var kCookieManager_GetAllCookies_Name = 1121163221;
  var kCookieManager_GetAllCookiesWithAccessSemantics_Name = 559077923;
  var kCookieManager_GetCookieList_Name = 2014090233;
  var kCookieManager_SetCanonicalCookie_Name = 1591326786;
  var kCookieManager_DeleteCanonicalCookie_Name = 1531470639;
  var kCookieManager_DeleteCookies_Name = 97395069;
  var kCookieManager_DeleteSessionOnlyCookies_Name = 918070909;
  var kCookieManager_AddCookieChangeListener_Name = 2116452810;
  var kCookieManager_AddGlobalChangeListener_Name = 2072249891;
  var kCookieManager_CloneInterface_Name = 746545129;
  var kCookieManager_FlushCookieStore_Name = 1154061132;
  var kCookieManager_AllowFileSchemeCookies_Name = 641433912;
  var kCookieManager_SetContentSettings_Name = 883592052;
  var kCookieManager_SetForceKeepSessionState_Name = 876069093;
  var kCookieManager_BlockThirdPartyCookies_Name = 816852893;
  var kCookieManager_SetContentSettingsForLegacyCookieAccess_Name = 2143149625;
  var kCookieManager_SetStorageAccessGrantSettings_Name = 1035293488;
  var kCookieManager_SetTopLevelStorageAccessSettings_Name = 486066643;
  ...
  CookieManagerPtr.prototype.setTopLevelStorageAccessSettings = function() {
    return CookieManagerProxy.prototype.setTopLevelStorageAccessSettings
        .apply(this.ptr.getProxy(), arguments);
  };

  CookieManagerProxy.prototype.setTopLevelStorageAccessSettings = function(settings) {
    var params_ = new CookieManager_SetTopLevelStorageAccessSettings_Params();
    params_.settings = settings;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
          kCookieManager_SetTopLevelStorageAccessSettings_Name,
          codec.align(CookieManager_SetTopLevelStorageAccessSettings_Params.encodedSize),
          codec.kMessageExpectsResponse, 0);
      builder.encodeStruct(CookieManager_SetTopLevelStorageAccessSettings_Params, params_);
      var message = builder.finish();
      this.receiver_.acceptAndExpectResponse(message).then(function(message) {
        var reader = new codec.MessageReader(message);
        var responseParams =
            reader.decodeStruct(CookieManager_SetTopLevelStorageAccessSettings_ResponseParams);
        resolve(responseParams);
      }).catch(function(result) {
        reject(Error("Connection error: " + result));
      });
  ...
  CookieManagerStub.prototype.setTopLevelStorageAccessSettings = function(settings) {
    return this.delegate_ && this.delegate_.setTopLevelStorageAccessSettings && this.delegate_.setTopLevelStorageAccessSettings(settings);
  }
  ...
  CookieManagerStub.prototype.acceptWithResponder =
    ...
    case kCookieManager_SetStorageAccessGrantSettings_Name:
      ...
      return true;
    case kCookieManager_SetTopLevelStorageAccessSettings_Name:
      var params = reader.decodeStruct(CookieManager_SetTopLevelStorageAccessSettings_Params);
      this.setTopLevelStorageAccessSettings(params.settings).then(function(response) {
        var responseParams =
            new CookieManager_SetTopLevelStorageAccessSettings_ResponseParams();
        var builder = new codec.MessageV1Builder(
            kCookieManager_SetTopLevelStorageAccessSettings_Name,
            codec.align(CookieManager_SetTopLevelStorageAccessSettings_ResponseParams.encodedSize),
            codec.kMessageIsResponse, reader.requestID);
        builder.encodeStruct(CookieManager_SetTopLevelStorageAccessSettings_ResponseParams,
                             responseParams);
        var message = builder.finish();
        responder.accept(message);
      });
  ...
  function validateCookieManagerRequest(messageValidator) {
    ...
    switch (message.getName()) {
      ...
      case kCookieManager_SetTopLevelStorageAccessSettings_Name:
        if (message.expectsResponse())
          paramsClass = CookieManager_SetTopLevelStorageAccessSettings_Params;
      break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
  ...
  function validateCookieManagerResponse(messageValidator) {
   ...
   switch (message.getName()) {
      ...
      case kCookieManager_SetTopLevelStorageAccessSettings_Name:
        if (message.isResponse())
          paramsClass = CookieManager_SetTopLevelStorageAccessSettings_ResponseParams;
        break;
    }
    if (paramsClass === null)
      return validator.validationError.NONE;
