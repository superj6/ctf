...
(function() {
  ...
  NetworkContextParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateUnion(offset + codec.kStructHeaderSize + 40, transferable_directory$.TransferableDirectory, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, ssl_config$.SSLConfig, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 80, proxy_config_with_annotation$.ProxyConfigWithAnnotation, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.proxyConfigClientReceiver
    err = messageValidator.validateInterfaceRequest(offset + codec.kStructHeaderSize + 76, true)
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.initialCustomProxyConfig
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 88, CustomProxyConfig, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 132, SCTAuditingMode);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.ctPolicy
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 136, CTPolicy, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate NetworkContextParams.certVerifierParams
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 144, CertVerifierServiceRemoteParams, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 200, HttpAuthStaticNetworkContextParams, true);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 208, NetworkContextFilePaths, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContextParams.decode = function(decoder) {
    ...
    val.requireNetworkIsolationKey = (packed >> 2) & 1 ? true : false;
  ...
  NetworkContextParams.encode = function(encoder, val) {
    ...
    packed |= (val.requireNetworkIsolationKey & 1) << 2
  ...
  URLLoaderFactoryParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 96, TrustTokenRedemptionPolicy);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 112, cookie_setting_overrides$.CookieSettingOverrides, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLLoaderFactoryParams.encodedSize = codec.kStructHeaderSize + 120;
  ...
  NetworkContext_CreateRestrictedUDPSocket_Params.validate = function(messageValidator, offset) {
    ...
    // validate NetworkContext_CreateRestrictedUDPSocket_Params.options
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, udp_socket$.UDPSocketOptions, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  NetworkContext_CreateRestrictedUDPSocket_Params.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(udp_socket$.UDPSocketOptions, val.options);
    encoder.encodeStruct(new codec.NullableInterface(udp_socket$.UDPSocketListenerPtr), val.listener);
  };
  ...
  var kCustomProxyConnectionObserver_OnFallback_Name = 155823277;
  var kCustomProxyConnectionObserver_OnTunnelHeadersReceived_Name = 483297258;
  ...
  var kCustomProxyConfigClient_OnCustomProxyConfigUpdated_Name = 1265790766;
  var kCustomProxyConfigClient_MarkProxiesAsBad_Name = 2041098871;
  var kCustomProxyConfigClient_ClearBadProxiesCache_Name = 910212558;
  ...
  var kTrustedHeaderClient_OnBeforeSendHeaders_Name = 1104348782;
  var kTrustedHeaderClient_OnHeadersReceived_Name = 618956564;
  ...
  var kTrustedURLLoaderHeaderClient_OnLoaderCreated_Name = 843279035;
  var kTrustedURLLoaderHeaderClient_OnLoaderForCorsPreflightCreated_Name = 488919954;
  ...
  var kNetworkContextClient_OnFileUploadRequested_Name = 865758418;
  var kNetworkContextClient_OnCanSendReportingReports_Name = 1504327518;
  var kNetworkContextClient_OnCanSendDomainReliabilityUpload_Name = 2075737151;
  var kNetworkContextClient_OnCanSendSCTAuditingReport_Name = 81495035;
  var kNetworkContextClient_OnNewSCTAuditingReportSent_Name = 973706587;
  ...
  var kNetworkContext_SetClient_Name = 329724330;
  var kNetworkContext_CreateURLLoaderFactory_Name = 1574581390;
  var kNetworkContext_ResetURLLoaderFactories_Name = 1678805638;
  var kNetworkContext_GetViaObliviousHttp_Name = 241117160;
  var kNetworkContext_GetCookieManager_Name = 372931218;
  var kNetworkContext_GetRestrictedCookieManager_Name = 1725414698;
  var kNetworkContext_GetTrustTokenQueryAnswerer_Name = 1530348475;
  var kNetworkContext_ClearTrustTokenData_Name = 1476255400;
  var kNetworkContext_GetStoredTrustTokenCounts_Name = 792067739;
  var kNetworkContext_DeleteStoredTrustTokens_Name = 160551497;
  var kNetworkContext_SetBlockTrustTokens_Name = 1841747794;
  var kNetworkContext_ClearNetworkingHistoryBetween_Name = 1814524813;
  var kNetworkContext_ClearHttpCache_Name = 183198005;
  var kNetworkContext_ComputeHttpCacheSize_Name = 117072705;
  var kNetworkContext_NotifyExternalCacheHit_Name = 34748723;
  var kNetworkContext_ClearHostCache_Name = 1456086797;
  var kNetworkContext_ClearHttpAuthCache_Name = 1676364903;
  var kNetworkContext_ClearReportingCacheReports_Name = 261423605;
  var kNetworkContext_ClearReportingCacheClients_Name = 796468709;
  var kNetworkContext_ClearNetworkErrorLogging_Name = 959624440;
  var kNetworkContext_ClearDomainReliability_Name = 1079414962;
  var kNetworkContext_SetDocumentReportingEndpoints_Name = 1745047520;
  var kNetworkContext_SendReportsAndRemoveSource_Name = 1242131700;
  var kNetworkContext_QueueReport_Name = 16227360;
  var kNetworkContext_QueueSignedExchangeReport_Name = 1333750386;
  var kNetworkContext_CloseAllConnections_Name = 1889242779;
  var kNetworkContext_CloseIdleConnections_Name = 480192247;
  var kNetworkContext_SetNetworkConditions_Name = 727917772;
  var kNetworkContext_SetAcceptLanguage_Name = 865708994;
  var kNetworkContext_SetEnableReferrers_Name = 123481399;
  var kNetworkContext_SetEnablePreconnect_Name = 1323616203;
  var kNetworkContext_SetCTPolicy_Name = 2090103784;
  var kNetworkContext_CreateUDPSocket_Name = 1325147701;
  var kNetworkContext_CreateRestrictedUDPSocket_Name = 1601578452;
  var kNetworkContext_CreateTCPServerSocket_Name = 1879157233;
  var kNetworkContext_CreateTCPConnectedSocket_Name = 1132872786;
  var kNetworkContext_CreateTCPBoundSocket_Name = 456975517;
  var kNetworkContext_CreateProxyResolvingSocketFactory_Name = 281276238;
  var kNetworkContext_LookUpProxyForURL_Name = 569091974;
  var kNetworkContext_ForceReloadProxyConfig_Name = 767488147;
  var kNetworkContext_ClearBadProxiesCache_Name = 1814583845;
  var kNetworkContext_CreateWebSocket_Name = 1553549295;
  var kNetworkContext_CreateWebTransport_Name = 1831973965;
  var kNetworkContext_CreateNetLogExporter_Name = 1471110887;
  var kNetworkContext_PreconnectSockets_Name = 287715930;
  var kNetworkContext_CreateP2PSocketManager_Name = 323158255;
  var kNetworkContext_CreateMdnsResponder_Name = 322906198;
  var kNetworkContext_ResolveHost_Name = 411390741;
  var kNetworkContext_CreateHostResolver_Name = 1807796678;
  var kNetworkContext_VerifyCertForSignedExchange_Name = 1667165323;
  var kNetworkContext_AddHSTS_Name = 1348707829;
  var kNetworkContext_IsHSTSActiveForHost_Name = 41698878;
  var kNetworkContext_GetHSTSState_Name = 482937477;
  var kNetworkContext_SetCorsOriginAccessListsForOrigin_Name = 1980451005;
  var kNetworkContext_DeleteDynamicDataForHost_Name = 1399664737;
  var kNetworkContext_SetSplitAuthCacheByNetworkAnonymizationKey_Name = 1093338174;
  var kNetworkContext_SaveHttpAuthCacheProxyEntries_Name = 797284889;
  var kNetworkContext_LoadHttpAuthCacheProxyEntries_Name = 895611411;
  var kNetworkContext_AddAuthCacheEntry_Name = 779049098;
  var kNetworkContext_SetCorsNonWildcardRequestHeadersSupport_Name = 1785542779;
  var kNetworkContext_LookupServerBasicAuthCredentials_Name = 1447743609;
  var kNetworkContext_EnableStaticKeyPinningForTesting_Name = 908657970;
  var kNetworkContext_VerifyCertificateForTesting_Name = 1020747529;
  var kNetworkContext_AddDomainReliabilityContextForTesting_Name = 17905838;
  var kNetworkContext_ForceDomainReliabilityUploadsForTesting_Name = 1387781808;
  var kNetworkContext_SetCTLogListAlwaysTimelyForTesting_Name = 1452705241;
  var kNetworkContext_SetSCTAuditingMode_Name = 1153401692;
  var kNetworkContext_AddReportingApiObserver_Name = 1741881654;
  ...
  NetworkContextProxy.prototype.createRestrictedUDPSocket = function(addr, mode, trafficAnnotation, options, receiver, listener) {
  ...
  NetworkContextStub.prototype.createRestrictedUDPSocket = function(addr, mode, trafficAnnotation, options, receiver, listener) {
    return this.delegate_ && this.delegate_.createRestrictedUDPSocket && this.delegate_.createRestrictedUDPSocket(addr, mode, trafficAnnotation, options, receiver, listener);
  }
  ...
  NetworkContextStub.prototype.acceptWithResponder =
    ...
    case kNetworkContext_CreateRestrictedUDPSocket_Name:
      ...
      this.createRestrictedUDPSocket(params.addr, params.mode, params.trafficAnnotation, params.options, params.receiver, params.listener).then(function(response) {
        var responseParams =
