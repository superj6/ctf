...
(function() {
  ...
  ExtensionLoadedParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, activation_sequence$.ActivationSequence, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  var kRenderer_ActivateExtension_Name = 1275679328;
  var kRenderer_SetActivityLoggingEnabled_Name = 1836142089;
  var kRenderer_LoadExtensions_Name = 1096835777;
  var kRenderer_UnloadExtension_Name = 465799285;
  var kRenderer_SuspendExtension_Name = 723444343;
  var kRenderer_CancelSuspendExtension_Name = 283623029;
  var kRenderer_SetDeveloperMode_Name = 1763973235;
  var kRenderer_SetSessionInfo_Name = 172078835;
  var kRenderer_SetSystemFont_Name = 1265482955;
  var kRenderer_SetWebViewPartitionID_Name = 1412058623;
  var kRenderer_SetScriptingAllowlist_Name = 2108552071;
  var kRenderer_ShouldSuspend_Name = 1517069920;
  var kRenderer_TransferBlobs_Name = 1739618628;
  var kRenderer_UpdatePermissions_Name = 492367937;
  var kRenderer_UpdateDefaultPolicyHostRestrictions_Name = 1840970597;
  var kRenderer_UpdateUserHostRestrictions_Name = 1912386218;
  var kRenderer_UpdateTabSpecificPermissions_Name = 111631142;
  var kRenderer_UpdateUserScripts_Name = 1047772000;
  var kRenderer_ClearTabSpecificPermissions_Name = 1157233044;
  var kRenderer_WatchPages_Name = 49949358;
