...
(function() {
  ...
  function InterestGroupSize(values) {
    this.initDefaults_();
    this.initFields_(values);
  }

  InterestGroupSize.LengthUnit = {};
  InterestGroupSize.LengthUnit.kInvalid = 0;
  InterestGroupSize.LengthUnit.kPixels = 1;
  InterestGroupSize.LengthUnit.kScreenWidth = 2;
  InterestGroupSize.LengthUnit.MIN_VALUE = 0;
  InterestGroupSize.LengthUnit.MAX_VALUE = 2;
  InterestGroupSize.LengthUnit.DEFAULT_VALUE = 0;

  InterestGroupSize.LengthUnit.isKnownEnumValue = function(value) {
    switch (value) {
    case 0:
    case 1:
    case 2:
  ...
  InterestGroupSize.LengthUnit.toKnownEnumValue = function(value) {
    if (this.isKnownEnumValue(value))
      return value;
    return this.DEFAULT_VALUE;
  };

  InterestGroupSize.LengthUnit.validate = function(enumValue) {
  ...
  InterestGroupSize.prototype.initDefaults_ = function() {
    this.width = 0;
    this.widthUnits = 0;
    this.heightUnits = 0;
    this.height = 0;
  };
  InterestGroupSize.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  InterestGroupSize.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate InterestGroupSize.widthUnits
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 8, InterestGroupSize.LengthUnit);
    if (err !== validator.validationError.NONE)
        return err;



    // validate InterestGroupSize.heightUnits
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, InterestGroupSize.LengthUnit);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InterestGroupSize.encodedSize = codec.kStructHeaderSize + 24;

  InterestGroupSize.decode = function(decoder) {
    var packed;
    var val = new InterestGroupSize();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.width =
        decoder.decodeStruct(codec.Double);
    val.widthUnits =
        decoder.decodeStruct(new codec.Enum(InterestGroupSize.LengthUnit));
    val.heightUnits =
        decoder.decodeStruct(new codec.Enum(InterestGroupSize.LengthUnit));
    val.height =
        decoder.decodeStruct(codec.Double);
  ...
  InterestGroupSize.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(InterestGroupSize.encodedSize);
    encoder.writeUint32(0);
  ...
  InterestGroup.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 136, true, codec.String, new codec.PointerTo(InterestGroupSize), false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  InterestGroup.encodedSize = codec.kStructHeaderSize + 152;
  ...
  InterestGroup.decode = function(decoder) {
    ...
    val.adComponents =
        decoder.decodeArrayPointer(new codec.PointerTo(InterestGroupAd));
    val.adSizes =
        decoder.decodeMapPointer(codec.String, new codec.PointerTo(InterestGroupSize));
    val.sizeGroups =
  ...
  InterestGroup.encode = function(encoder, val) {
    ...
    encoder.encodeMapPointer(codec.String, new codec.PointerTo(InterestGroupSize), val.adSizes);
  ...
  AuctionAdConfigNonSharedParams.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 80, false, new codec.PointerTo(origin$.Origin), codec.Uint16, false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AuctionAdConfigNonSharedParams.perBuyerPrioritySignals
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 88, true, new codec.PointerTo(origin$.Origin), new codec.MapOf(codec.String, codec.Double), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AuctionAdConfigNonSharedParams.allBuyersPrioritySignals
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 96, true, codec.String, codec.Double, false);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 112, 8, new codec.PointerTo(int128$.Uint128), true, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AuctionAdConfigNonSharedParams.auctionReportBuyers
    err = messageValidator.validateMapPointer(offset + codec.kStructHeaderSize + 120, true, new codec.Enum(AuctionAdConfigNonSharedParams.BuyerReportType), new codec.PointerTo(AuctionReportBuyersConfig), false);
    if (err !== validator.validationError.NONE)
        return err;


    // validate AuctionAdConfigNonSharedParams.componentAuctions
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 128, 8, new codec.PointerTo(AuctionAdConfig), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  AuctionAdConfigNonSharedParams.encodedSize = codec.kStructHeaderSize + 136;
  ...
  exports.InterestGroupSize = InterestGroupSize;
