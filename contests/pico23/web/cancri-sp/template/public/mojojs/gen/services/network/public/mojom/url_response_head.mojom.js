...
(function() {
  ...
  URLResponseHead.validate = function(messageValidator, offset) {
    ...
    // validate URLResponseHead.triggerAttestation
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 232, attribution$.TriggerAttestation, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  URLResponseHead.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(attribution$.TriggerAttestation, val.triggerAttestation);
  };
