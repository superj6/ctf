...
(function() {
  ...
  TextureQuadState.validate = function(messageValidator, offset) {
    ...
    // validate TextureQuadState.hdrMode
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 56, hdr_metadata$.HDRMode);
    if (err !== validator.validationError.NONE)
        return err;


    // validate TextureQuadState.hdrMetadata
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 64, hdr_metadata$.HDRMetadata, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate TextureQuadState.damageRect
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 72, geometry$.Rect, true);
    if (err !== validator.validationError.NONE)
        return err;


    // validate TextureQuadState.overlayPriorityHint
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 60, OverlayPriority);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  TextureQuadState.decode = function(decoder) {
    ...
    val.hdrMode =
        decoder.decodeStruct(new codec.Enum(hdr_metadata$.HDRMode));
  ...
  TextureQuadState.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.Int32, val.hdrMode);
