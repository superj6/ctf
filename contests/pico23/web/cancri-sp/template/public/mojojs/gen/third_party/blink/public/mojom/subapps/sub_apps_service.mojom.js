...
(function() {
  ...
  SubAppsServiceAddParameters.validate = function(messageValidator, offset) {
    ...
    // validate SubAppsServiceAddParameters.unhashedAppIdPath
  ...
  SubAppsServiceAddParameters.encode = function(encoder, val) {
    ...
    encoder.encodeStruct(codec.String, val.unhashedAppIdPath);
  ...
  SubAppsServiceAddResult.validate = function(messageValidator, offset) {
    ...
    // validate SubAppsServiceAddResult.unhashedAppIdPath
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SubAppsServiceListResultEntry.validate = function(messageValidator, offset) {
    ...
    // validate SubAppsServiceListResultEntry.unhashedAppIdPath
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SubAppsService_Remove_Params.validate = function(messageValidator, offset) {
    ...
    // validate SubAppsService_Remove_Params.unhashedAppIdPath
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SubAppsServiceProxy.prototype.remove = function(unhashedAppIdPath) {
    var params_ = new SubAppsService_Remove_Params();
    params_.unhashedAppIdPath = unhashedAppIdPath;
    return new Promise(function(resolve, reject) {
      var builder = new codec.MessageV1Builder(
  ...
  SubAppsServiceStub.prototype.remove = function(unhashedAppIdPath) {
    return this.delegate_ && this.delegate_.remove && this.delegate_.remove(unhashedAppIdPath);
  }
  ...
  SubAppsServiceStub.prototype.acceptWithResponder =
    ...
    case kSubAppsService_Remove_Name:
      ...
      this.remove(params.unhashedAppIdPath).then(function(response) {
        var responseParams =
