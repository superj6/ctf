...
(function() {
  ...
  SharedStorageBudgetMetadata.validate = function(messageValidator, offset) {
    ...
    // validate SharedStorageBudgetMetadata.origin
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 0, origin$.Origin, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  SharedStorageBudgetMetadata.decode = function(decoder) {
    ...
    val.reportEventCalled = (packed >> 1) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  SharedStorageBudgetMetadata.encode = function(encoder, val) {
    ...
    packed |= (val.reportEventCalled & 1) << 1
  ...
  FencedFrameConfig.encodedSize = codec.kStructHeaderSize + 128;
  ...
  FencedFrameProperties.encodedSize = codec.kStructHeaderSize + 120;
