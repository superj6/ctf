...
(function() {
  ...
  DisplaySnapshot.prototype.initDefaults_ = function() {
    ...
    this.verticalDisplayRangeLimits = null;
  };
  ...
  DisplaySnapshot.validate = function(messageValidator, offset) {
    ...
    // validate DisplaySnapshot.verticalDisplayRangeLimits
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 168, range$.Range, true);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  DisplaySnapshot.decode = function(decoder) {
    ...
    decoder.skip(1);
    decoder.skip(1);
    val.verticalDisplayRangeLimits =
  ...
  DisplaySnapshot.encode = function(encoder, val) {
    ...
    encoder.skip(1);
    encoder.skip(1);
    encoder.encodeStructPointer(range$.Range, val.verticalDisplayRangeLimits);
  };
