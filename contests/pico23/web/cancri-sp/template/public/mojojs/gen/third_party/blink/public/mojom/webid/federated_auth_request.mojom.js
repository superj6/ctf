...
(function() {
  ...
  RequestUserInfoStatus.kErrorTooManyRequests = 1;
  RequestUserInfoStatus.kError = 2;
  RequestUserInfoStatus.MIN_VALUE = 0;
  RequestUserInfoStatus.MAX_VALUE = 2;
  ...
  function IdentityProviderLoginHint(values) {
    this.initDefaults_();
    this.initFields_(values);
  }


  IdentityProviderLoginHint.prototype.initDefaults_ = function() {
    this.email = null;
    this.id = null;
    this.isRequired = false;
  };
  IdentityProviderLoginHint.prototype.initFields_ = function(fields) {
    for(var field in fields) {
        if (this.hasOwnProperty(field))
          this[field] = fields[field];
    }
  ...
  IdentityProviderLoginHint.validate = function(messageValidator, offset) {
    var err;
    err = messageValidator.validateStructHeader(offset, codec.kStructHeaderSize);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    // validate IdentityProviderLoginHint.email
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 0, false)
    if (err !== validator.validationError.NONE)
        return err;


    // validate IdentityProviderLoginHint.id
    err = messageValidator.validateStringPointer(offset + codec.kStructHeaderSize + 8, false)
    if (err !== validator.validationError.NONE)
        return err;
  ...
  IdentityProviderLoginHint.encodedSize = codec.kStructHeaderSize + 24;

  IdentityProviderLoginHint.decode = function(decoder) {
    var packed;
    var val = new IdentityProviderLoginHint();
    var numberOfBytes = decoder.readUint32();
    var version = decoder.readUint32();
    val.email =
        decoder.decodeStruct(codec.String);
    ...
    val.isRequired = (packed >> 0) & 1 ? true : false;
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
    decoder.skip(1);
  ...
  IdentityProviderLoginHint.encode = function(encoder, val) {
    var packed;
    encoder.writeUint32(IdentityProviderLoginHint.encodedSize);
    encoder.writeUint32(0);
    encoder.encodeStruct(codec.String, val.email);
    encoder.encodeStruct(codec.String, val.id);
    packed = 0;
    packed |= (val.isRequired & 1) << 0
  ...
  IdentityProviderConfig.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateStructPointer(offset + codec.kStructHeaderSize + 24, IdentityProviderLoginHint, false);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  IdentityProviderConfig.decode = function(decoder) {
    ...
    val.nonce =
        decoder.decodeStruct(codec.String);
    val.loginHint =
        decoder.decodeStructPointer(IdentityProviderLoginHint);
    return val;
  };
  ...
  IdentityProviderConfig.encode = function(encoder, val) {
    ...
    encoder.encodeStructPointer(IdentityProviderLoginHint, val.loginHint);
  };
  ...
  IdentityProviderGetParameters.validate = function(messageValidator, offset) {
    ...
    err = messageValidator.validateArrayPointer(offset + codec.kStructHeaderSize + 0, 8, new codec.PointerTo(IdentityProviderConfig), false, [0], 0);
    if (err !== validator.validationError.NONE)
        return err;
    ...
    err = messageValidator.validateEnum(offset + codec.kStructHeaderSize + 12, RpContext);
    if (err !== validator.validationError.NONE)
        return err;
  ...
  IdentityProviderGetParameters.decode = function(decoder) {
    ...
    var version = decoder.readUint32();
    val.providers =
        decoder.decodeArrayPointer(new codec.PointerTo(IdentityProviderConfig));
    packed = decoder.readUint8();
  ...
  IdentityProviderGetParameters.encode = function(encoder, val) {
    ...
    encoder.writeUint32(0);
    encoder.encodeArrayPointer(new codec.PointerTo(IdentityProviderConfig), val.providers);
    packed = 0;
  ...
  FederatedAuthRequest_RequestToken_Params.encodedSize = codec.kStructHeaderSize + 8;
  ...
  var kFederatedAuthRequest_LogoutRps_Name = 3;
  ...
  FederatedAuthRequestProxy.prototype.requestToken = function(idpGetParams) {
  ...
  FederatedAuthRequestStub.prototype.requestToken = function(idpGetParams) {
    return this.delegate_ && this.delegate_.requestToken && this.delegate_.requestToken(idpGetParams);
  }
  ...
  FederatedAuthRequestStub.prototype.acceptWithResponder =
    ...
    case kFederatedAuthRequest_RequestToken_Name:
      ...
      this.requestToken(params.idpGetParams).then(function(response) {
        var responseParams =
  ...
  exports.IdentityProviderLoginHint = IdentityProviderLoginHint;
